        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                (
                    "user",
                    models.ForeignKey(
                        on_delete=models.CASCADE, related_name="calendar_watches", to="voice.user"
                    ),
                ),
                (
                    "channel_id",
                    models.CharField(
                        max_length=255, unique=True, help_text="Google Calendar channel ID"
                    ),
                ),
                (
                    "resource_id",
                    models.CharField(max_length=255, help_text="Google Calendar resource ID"),
                ),
            ...
            options={
                ...
                "indexes": [
                    ...
                    models.Index(
                        fields=["channel_id"], name="voice_googlecalendarwatch_channel_id_idx"
                    ),
                    models.Index(
                        fields=["expiration"], name="voice_googlecalendarwatch_expiration_idx"
                    ),
                ],
            },
        ),
