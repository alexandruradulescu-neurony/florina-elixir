...
urlpatterns = [
    ...
    path(
        "manager/methodologies/add/",
        views.MethodologyCreateView.as_view(),
        name="methodology_create",
    ),
    path(
        "manager/methodologies/<int:methodology_id>/edit/",
        views.MethodologyEditView.as_view(),
    ...
    path(
        "manager/visits/<int:visit_id>/status/<str:status>/",
    ...
    path(
        "manager/agents/<int:agent_id>/methodology/",
        views.AgentMethodologyView.as_view(),
        name="agent_methodology",
    ),
    # Clients
